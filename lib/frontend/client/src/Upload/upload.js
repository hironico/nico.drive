...
class Upload extends Component {
    ...
    startUpload() {
        ...
        let oneFile = this.state.filesToSend.pop();
        this.state.pendingFiles.push(oneFile);
    ...
    uploadFinish(evt) {
        ...
        const finishedFile = this.state.pendingFiles.pop();
        console.log('Finished file: ' + JSON.stringify(finishedFile));
